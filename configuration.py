...
HEADERS = {
    'X-EBAY-API-CALL-NAME': 'GetCategoriesApi',
...
try:
    ...
    ALL_CATEGORIES = """<?xml version="1.0" encoding="utf-8"?>
    ...
    </GetCategoriesRequest>""" % EBAY_AUTH_TOKEN
except KeyError:
    print('Something went wrong in the configuration')
    exit(1)